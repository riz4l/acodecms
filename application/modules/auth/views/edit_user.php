...
<head>
  ...
  <title>AcodeCMS | Edit Users</title>
              ...
              <div id="infoMessage"><?php echo $message;?></div>
                  ...
                  <div class="box box-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title"><a href="<?php echo base_url()?>auth" class="btn btn-sm btn-info"><i class="fa fa-chevron-left"></i></a> <?php echo lang('edit_user_heading');?></h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
